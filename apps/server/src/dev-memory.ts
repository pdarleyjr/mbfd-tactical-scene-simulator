...
const app = await createApp({ repository, signingSecret, instructorPin: '246810', assetStoragePath: path.join(repositoryRoot, 'data/assets'), publicBaseUrl: 'http://127.0.0.1:5173', enableRateLimit: false, release: 'e2e' })
